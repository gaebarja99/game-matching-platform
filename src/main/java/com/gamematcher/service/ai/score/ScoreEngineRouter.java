...
public class ScoreEngineRouter {
    ...
    private final ValorantScoreEngine valorantEngine;
    private final LolScoreEngine lolEngine;
    private final Optional<GenericScoreEngine> genericEngine;

    public ScoreEngineRouter(ValorantScoreEngine valorantEngine,
                             LolScoreEngine lolEngine,
                             Optional<GenericScoreEngine> genericEngine) {
        this.valorantEngine = valorantEngine;
    ...
    public Optional<Integer> calculate(String gameCode, BaseStatsDTO stats) {
        ...
        return switch (game) {
            case VALORANT -> stats instanceof ValorantMatchStatsDTO v
