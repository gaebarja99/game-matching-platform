    ...
    <div className="streams-page">
      ...
      <div className="layout">
        <aside className="sidebar">
          <Link to="/streams" className={`sidebar-item ${sidebarItems.some((i) => i.to === '/streams') ? 'active' : ''}`}><span className="icon">●</span> 인기 방송</Link>
          <Link to="/streams?sort=popular" className="sidebar-item"><span className="icon">◆</span> 게임</Link>
