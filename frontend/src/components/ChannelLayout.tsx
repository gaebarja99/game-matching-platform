    ...
    <div className="channel-page">
      <header className="header">
        ...
        <div className="header-right">
          {user && (
            <Link to="/studio" className="auth-only" style={{ padding: '8px 14px', borderRadius: 8, fontSize: '0.9rem', fontWeight: 500, border: '1px solid #00e676', color: '#00e676', textDecoration: 'none' }}>스튜디오</Link>
          )}
