...
export default function ProfileLayout() {
  ...
  const handlePendingMenu = (label: string) => {
        ...
        <aside className="profile-sidebar">
          <div className="nav-section">
            ...
            <NavLink to="/profile/account-links" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
              <span className="icon">🔗</span> 외부 계정 연동
            </NavLink>
          </div>
          ...
          <div className="nav-section">
            ...
            <NavLink to="/profile/adfree" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
              <span className="icon">🚫</span> 광고 제거
            </NavLink>
          ...
          <div className="nav-section">
            ...
            <button type="button" className="nav-item" onClick={() => handlePendingMenu('작성한 글')}>
              <span className="icon">📄</span> 작성한 글
            </button>
            <button type="button" className="nav-item" onClick={() => handlePendingMenu('저장한 글')}>
