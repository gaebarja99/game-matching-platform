        ...
        <aside className="profile-sidebar">
          <div className="nav-section">
            ...
            <NavLink to="/profile" end className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
              <SidebarIcon>
                <svg viewBox="0 0 24 24"><path d="M12 12c2.76 0 5-2.24 5-5S14.76 2 12 2 7 4.24 7 7s2.24 5 5 5Zm0 2c-4.42 0-8 2.24-8 5v1h16v-1c0-2.76-3.58-5-8-5Z" /></svg>
              </SidebarIcon>
              <span>내 프로필</span>
            </NavLink>
            <NavLink to="/profile/my-info" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
              <SidebarIcon>
                <svg viewBox="0 0 24 24"><path d="M7 3h8l4 4v14H7V3Zm7 1.5V8h3.5" /><path d="M10 12h6M10 16h6" /></svg>
              </SidebarIcon>
              <span>내 정보</span>
            </NavLink>
            <NavLink to="/profile/account-links" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
              <SidebarIcon>
                <svg viewBox="0 0 24 24"><path d="M10.59 13.41a1.996 1.996 0 0 0 2.82 0l3.59-3.59a2 2 0 1 0-2.83-2.83l-1.29 1.29" /><path d="M13.41 10.59a1.996 1.996 0 0 0-2.82 0L7 14.18a2 2 0 0 0 2.83 2.83l1.29-1.29" /></svg>
              </SidebarIcon>
              <span>외부 계정 연동</span>
            </NavLink>
          </div>
          ...
          <div className="nav-section">
            ...
            <Link to="/studio" className="nav-item">
              <SidebarIcon>
                <svg viewBox="0 0 24 24"><rect x="3" y="5" width="18" height="14" rx="2" /><path d="M8 3v4M16 3v4M3 10h18" /></svg>
              </SidebarIcon>
              <span>스튜디오</span>
            </Link>
            <Link to="/channel" className="nav-item">
              <SidebarIcon>
                <svg viewBox="0 0 24 24"><path d="M4 6h16v12H4z" /><path d="M8 4v4M16 4v4" /></svg>
              </SidebarIcon>
              <span>내 채널</span>
            </Link>
            <NavLink to="/profile/pang" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
              <SidebarIcon>
                <svg viewBox="0 0 24 24"><path d="M12 2 8 9h3l-1 7 6-9h-3l2-5z" /></svg>
              </SidebarIcon>
              <span>내 팡</span>
            </NavLink>
            <NavLink to="/profile/subscriptions" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
              <SidebarIcon>
                <svg viewBox="0 0 24 24"><path d="m12 17 5 3-1-6 4-4-6-.9L12 3 10 9.1 4 10l4 4-1 6 5-3z" /></svg>
              </SidebarIcon>
              <span>내 구독</span>
            </NavLink>
            <NavLink to="/profile/adfree" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
              <SidebarIcon>
                <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" /><path d="M5 5l14 14" /></svg>
              </SidebarIcon>
              <span>광고 제거</span>
            </NavLink>
            <NavLink to="/profile/mileage-shop" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
              <SidebarIcon>
                <svg viewBox="0 0 24 24"><path d="M4 7h16v10H4z" /><path d="M8 11h8M8 15h5" /></svg>
              </SidebarIcon>
              <span>마일리지 상점</span>
            </NavLink>
            ...
            <NavLink to="/following" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
              <SidebarIcon>
                <svg viewBox="0 0 24 24"><path d="M12.1 20.3 4.8 13a4.5 4.5 0 0 1 6.4-6.4l.8.8.8-.8a4.5 4.5 0 1 1 6.4 6.4l-7.1 7.3z" /></svg>
              </SidebarIcon>
              <span>팔로잉 채널</span>
            </NavLink>
          </div>
